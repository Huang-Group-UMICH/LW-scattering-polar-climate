...
!------------------------------------------------------------------
      ...
      !yihsuan cancel subroutine mcica_subcol_lw(lchnk, ncol, nlay, icld, permuteseed, play, &
      !yihsaun cancel                 cldfrac, ciwp, clwp, rei, rel, tauc, cldfmcl, &
      !yihsuan cancel                 ciwpmcl, clwpmcl, reicmcl, relqmcl, taucmcl)

      !>>> yihsuan add 2017-07-04 >>>
      subroutine mcica_subcol_lw(lchnk, ncol, nlay, icld, permuteseed, play, &
                       cldfrac, ciwp, clwp, rei, rel, tauc, ssac, xmomc, &
                       cldfmcl, ciwpmcl, clwpmcl, reicmcl, relqmcl, taucmcl, ssacmcl, xmomcmcl)
      !<<< yihsuan add 2017-07-04 <<<
...
!  Generate the stochastic subcolumns of cloud optical properties for the longwave;
      !yihsuan cancel call generate_stochastic_clouds (ncol, nlay, nsubclw, icld, pmid, cldfrac, clwp, ciwp, tauc, &
      !yihsuan cancel                         cldfmcl, clwpmcl, ciwpmcl, taucmcl, permuteseed)
      call generate_stochastic_clouds (ncol, nlay, nsubclw, icld, pmid, cldfrac, clwp, ciwp, tauc, ssac, xmomc, &
                                       cldfmcl, clwpmcl, ciwpmcl, taucmcl, ssacmcl, xmomcmcl, permuteseed)

      end subroutine mcica_subcol_lw


!-------------------------------------------------------------------------------------------------
      !yihsuan cancel subroutine generate_stochastic_clouds(ncol, nlay, nsubcol, icld, pmid, cld, clwp, ciwp, tauc, &
      !yihsuan cancel                             cld_stoch, clwp_stoch, ciwp_stoch, tauc_stoch, changeSeed) 
      subroutine generate_stochastic_clouds(ncol, nlay, nsubcol, icld, pmid, cld, clwp, ciwp, tauc, ssac, xmomc, &
                                   cld_stoch, clwp_stoch, ciwp_stoch, tauc_stoch, ssac_stoch, xmomc_stoch, changeSeed) 
!-------------------------------------------------------------------------------------------------
