...
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/csm_share/trunk_tags/share3_121022/shr/shr_kind_mod.F90 $
!===============================================================================
...
MODULE shr_kind_mod
   ...
   !----------------------------------------------------------------------------
   public
   integer,parameter :: SHR_KIND_R8 = 8 !selected_real_kind(12) ! 8 byte real
   integer,parameter :: SHR_KIND_R4 = 4 !selected_real_kind( 6) ! 4 byte real
